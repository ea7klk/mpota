...
- Container images are built for `linux/arm64` for Apple Silicon development and `linux/amd64` for production Linux; Alpine is used for Node/Nginx/Redis/NATS components where dependencies support it.
