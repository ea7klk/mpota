...
export default function App() {
  ...
  const nav = useMemo(() => [{ id: 'home', label: t.home }, { id: 'map', label: t.map }, { id: 'propose', label: t.propose }, { id: 'qso', label: t.qso }, { id: 'uploads', label: t.uploads }, { id: 'awards', label: t.awards }, ...(canModerate ? [{ id: 'admin', label: t.admin }, { id: 'park-admin', label: t.parkAdmin }] : []), ...(canManageUsers ? [{ id: 'users', label: t.users }] : [])], [t, canModerate, canManageUsers]);
