...
import { policyCopy, PolicyKind } from './policies';
...
const copy: Record<Locale, Record<string, string>> = {
  en: { home: 'Home', map: 'Map', propose: 'Propose a park', qso: 'Log QSO', uploads: 'ADIF uploads', awards: 'Awards', admin: 'Moderation', parkAdmin: 'Park administration', users: 'Users', signIn: 'Sign in', register: 'Register', signOut: 'Sign out', homeEyebrow: 'A new frequency for local places', homeTitle: 'Put your city’s green spaces on the air.', homeMission: 'MPOTA brings amateur radio into the municipal parks people already know and use. We turn accessible public spaces into welcoming meeting points where radio amateurs can make contacts, share the hobby, and bring the community closer to the airwaves.', homeExplore: 'Explore approved parks', homeCommunity: 'Every city has a park. Every park can start a conversation.', homeWhyEyebrow: 'Why MPOTA', homeWhyTitle: 'A programme built around access, community, and discovery.', homeWhyText: 'Protected areas matter, but so do the everyday parks managed by our towns and cities. MPOTA gives these places a place in amateur radio while making the hobby more visible, more local, and easier for new people to encounter.', homeDiscoverTitle: 'Discover', homeDiscoverText: 'Find approved municipal parks on the map and plan your next activation.', homeContributeTitle: 'Contribute', homeContributeText: 'Know a great city park? Propose it and help grow the global reference list.', homeEarnTitle: 'Earn', homeEarnText: 'Log contacts, activate parks, and work toward MPOTA awards.', hero: 'Municipal parks on the air', heroText: 'Discover accessible places for amateur radio, propose a new park, and collect MPOTA awards.', approved: 'approved parks', choose: 'Choose a point on the map', submit: 'Submit proposal', email: 'Email', password: 'Password', name: 'Display name', callsign: 'Callsign', upload: 'Upload ADIF', loginRequired: 'Sign in to propose parks, upload logs, or manage MPOTA.', saveAward: 'Create award draft', proposalQueue: 'Proposal queue', approvedParks: 'Approved parks', remove: 'Remove', reviewNotes: 'Review notes', coordinates: 'Coordinates', pickLocation: 'Click the map to place the proposal marker.', access: 'Approval access', allCountries: 'All countries', countryScope: 'Countries', continentScope: 'Continents', saveAccess: 'Save access', deactivate: 'Deactivate', delete: 'Delete', noUsers: 'No users found', status: 'Status', role: 'Role' },
  es: { home: 'Inicio', map: 'Mapa', propose: 'Proponer un parque', qso: 'Registrar QSO', uploads: 'Cargas ADIF', awards: 'Premios', admin: 'Moderación', parkAdmin: 'Administración de parques', users: 'Usuarios', signIn: 'Iniciar sesión', register: 'Registrarse', signOut: 'Cerrar sesión', homeEyebrow: 'Una nueva frecuencia para los lugares de siempre', homeTitle: 'Pon los espacios verdes de tu ciudad en el aire.', homeMission: 'MPOTA acerca la radioafición a los parques municipales que las personas ya conocen y disfrutan. Convertimos espacios públicos accesibles en puntos de encuentro donde los radioaficionados hacen contactos, comparten su afición y acercan la comunidad a las ondas.', homeExplore: 'Explorar parques aprobados', homeCommunity: 'Cada ciudad tiene un parque. Cada parque puede iniciar una conversación.', homeWhyEyebrow: 'Por qué MPOTA', homeWhyTitle: 'Un programa basado en el acceso, la comunidad y el descubrimiento.', homeWhyText: 'Las áreas protegidas son importantes, pero también lo son los parques cotidianos gestionados por nuestros municipios. MPOTA incorpora estos lugares a la radioafición y hace la afición más visible, local y fácil de descubrir.', homeDiscoverTitle: 'Descubre', homeDiscoverText: 'Encuentra parques municipales aprobados en el mapa y planifica tu próxima activación.', homeContributeTitle: 'Contribuye', homeContributeText: '¿Conoces un buen parque urbano? Propónlo y ayuda a crecer la lista mundial.', homeEarnTitle: 'Consigue premios', homeEarnText: 'Registra contactos, activa parques y avanza hacia los premios MPOTA.', hero: 'Parques municipales en el aire', heroText: 'Descubre lugares accesibles para la radioafición, propone un parque y consigue premios MPOTA.', approved: 'parques aprobados', choose: 'Elige un punto en el mapa', submit: 'Enviar propuesta', email: 'Correo', password: 'Contraseña', name: 'Nombre visible', callsign: 'Indicativo', upload: 'Cargar ADIF', loginRequired: 'Inicia sesión para proponer parques, cargar logs o gestionar MPOTA.', saveAward: 'Crear borrador de premio', proposalQueue: 'Cola de propuestas', approvedParks: 'Parques aprobados', remove: 'Retirar', reviewNotes: 'Notas de revisión', coordinates: 'Coordenadas', pickLocation: 'Haz clic en el mapa para colocar el marcador.', access: 'Acceso de aprobación', allCountries: 'Todos los países', countryScope: 'Países', continentScope: 'Continentes', saveAccess: 'Guardar acceso', deactivate: 'Desactivar', delete: 'Eliminar', noUsers: 'No se encontraron usuarios', status: 'Estado', role: 'Rol' },
  fr: { home: 'Accueil', map: 'Carte', propose: 'Proposer un parc', qso: 'Enregistrer un QSO', uploads: 'Importations ADIF', awards: 'Récompenses', admin: 'Modération', parkAdmin: 'Administration des parcs', users: 'Utilisateurs', signIn: 'Connexion', register: "S'inscrire", signOut: 'Déconnexion', homeEyebrow: 'Une nouvelle fréquence pour les lieux du quotidien', homeTitle: 'Faites vivre les espaces verts de votre ville sur les ondes.', homeMission: 'MPOTA rapproche la radio amateur des parcs municipaux que chacun connaît et fréquente. Ces espaces publics accessibles deviennent des lieux de rencontre où les radioamateurs établissent des contacts, partagent leur passion et rapprochent la communauté des ondes.', homeExplore: 'Explorer les parcs approuvés', homeCommunity: 'Chaque ville a un parc. Chaque parc peut commencer une conversation.', homeWhyEyebrow: 'Pourquoi MPOTA', homeWhyTitle: 'Un programme fondé sur l’accès, la communauté et la découverte.', homeWhyText: 'Les espaces protégés sont importants, mais les parcs du quotidien gérés par nos villes le sont aussi. MPOTA leur donne une place dans la radio amateur et rend la passion plus visible, plus locale et plus facile à découvrir.', homeDiscoverTitle: 'Découvrir', homeDiscoverText: 'Trouvez des parcs municipaux approuvés sur la carte et préparez votre prochaine activation.', homeContributeTitle: 'Contribuer', homeContributeText: 'Vous connaissez un beau parc urbain ? Proposez-le et enrichissez la liste mondiale.', homeEarnTitle: 'Récompenser', homeEarnText: 'Enregistrez vos contacts, activez des parcs et progressez vers les récompenses MPOTA.', hero: 'Parcs municipaux sur les ondes', heroText: 'Découvrez des lieux accessibles pour la radio amateur, proposez un parc et obtenez des récompenses MPOTA.', approved: 'parcs approuvés', choose: 'Choisissez un point sur la carte', submit: 'Envoyer la proposition', email: 'E-mail', password: 'Mot de passe', name: 'Nom affiché', callsign: 'Indicatif', upload: 'Importer ADIF', loginRequired: 'Connectez-vous pour proposer des parcs, importer des logs ou gérer MPOTA.', saveAward: 'Créer un brouillon', proposalQueue: 'File des propositions', approvedParks: 'Parcs approuvés', remove: 'Retirer', reviewNotes: 'Notes de révision', coordinates: 'Coordonnées', pickLocation: 'Cliquez sur la carte pour placer le marqueur.', access: 'Accès d’approbation', allCountries: 'Tous les pays', countryScope: 'Pays', continentScope: 'Continents', saveAccess: 'Enregistrer l’accès', deactivate: 'Désactiver', delete: 'Supprimer', noUsers: 'Aucun utilisateur', status: 'Statut', role: 'Rôle' },
  de: { home: 'Start', map: 'Karte', propose: 'Park vorschlagen', qso: 'QSO protokollieren', uploads: 'ADIF-Uploads', awards: 'Auszeichnungen', admin: 'Moderation', parkAdmin: 'Parkverwaltung', users: 'Benutzer', signIn: 'Anmelden', register: 'Registrieren', signOut: 'Abmelden', homeEyebrow: 'Eine neue Frequenz für vertraute Orte', homeTitle: 'Bringe die Grünflächen deiner Stadt auf die Luft.', homeMission: 'MPOTA bringt den Amateurfunk in die kommunalen Parks, die Menschen bereits kennen und nutzen. Aus zugänglichen öffentlichen Orten werden Treffpunkte, an denen Funkamateure Kontakte knüpfen, ihre Leidenschaft teilen und die Gemeinschaft näher an den Funk bringen.', homeExplore: 'Genehmigte Parks entdecken', homeCommunity: 'Jede Stadt hat einen Park. Jeder Park kann ein Gespräch beginnen.', homeWhyEyebrow: 'Warum MPOTA', homeWhyTitle: 'Ein Programm für Zugang, Gemeinschaft und Entdeckung.', homeWhyText: 'Schutzgebiete sind wichtig, aber auch die alltäglichen Parks unserer Städte. MPOTA gibt diesen Orten einen Platz im Amateurfunk und macht das Hobby sichtbarer, lokaler und leichter zugänglich.', homeDiscoverTitle: 'Entdecken', homeDiscoverText: 'Finde genehmigte kommunale Parks auf der Karte und plane deine nächste Aktivierung.', homeContributeTitle: 'Mitmachen', homeContributeText: 'Du kennst einen schönen Stadtpark? Schlage ihn vor und erweitere die weltweite Referenzliste.', homeEarnTitle: 'Auszeichnungen', homeEarnText: 'Logge Kontakte, aktiviere Parks und arbeite auf MPOTA-Auszeichnungen hin.', hero: 'Kommunale Parks auf der Luft', heroText: 'Entdecke zugängliche Orte für den Amateurfunk, schlage Parks vor und sammle MPOTA-Auszeichnungen.', approved: 'genehmigte Parks', choose: 'Punkt auf der Karte wählen', submit: 'Vorschlag senden', email: 'E-Mail', password: 'Passwort', name: 'Anzeigename', callsign: 'Rufzeichen', upload: 'ADIF hochladen', loginRequired: 'Anmelden, um Parks vorzuschlagen, Logs hochzuladen oder MPOTA zu verwalten.', saveAward: 'Auszeichnungsentwurf erstellen', proposalQueue: 'Vorschlagswarteschlange', approvedParks: 'Genehmigte Parks', remove: 'Entfernen', reviewNotes: 'Prüfnotizen', coordinates: 'Koordinaten', pickLocation: 'Klicke auf die Karte, um den Marker zu platzieren.', access: 'Genehmigungszugriff', allCountries: 'Alle Länder', countryScope: 'Länder', continentScope: 'Kontinente', saveAccess: 'Zugriff speichern', deactivate: 'Deaktivieren', delete: 'Löschen', noUsers: 'Keine Benutzer gefunden', status: 'Status', role: 'Rolle' }
};

const homeEligibility: Record<Locale, { eyebrow: string; title: string; text: string }> = {
  en: { eyebrow: 'Programme boundary', title: 'MPOTA complements POTA — it does not compete with it.', text: 'A park already included in POTA is not eligible for MPOTA. MPOTA is reserved for municipally managed parks that are outside POTA, giving these accessible community spaces their own place in amateur radio.' },
  es: { eyebrow: 'Límite del programa', title: 'MPOTA complementa a POTA; no compite con ella.', text: 'Un parque que ya está incluido en POTA no es elegible para MPOTA. MPOTA está reservado para parques gestionados por municipios que están fuera de POTA, dando a estos espacios comunitarios accesibles su propio lugar en la radioafición.' },
  fr: { eyebrow: 'Périmètre du programme', title: 'MPOTA complète POTA — il ne le concurrence pas.', text: 'Un parc déjà inclus dans POTA n’est pas éligible à MPOTA. MPOTA est réservé aux parcs gérés par les municipalités et absents de POTA, afin d’offrir à ces espaces communautaires accessibles leur propre place dans la radio amateur.' },
  de: { eyebrow: 'Programmgrenze', title: 'MPOTA ergänzt POTA — es tritt nicht in Konkurrenz dazu.', text: 'Ein Park, der bereits in POTA enthalten ist, ist für MPOTA nicht zugelassen. MPOTA ist für kommunal verwaltete Parks außerhalb von POTA bestimmt und gibt diesen zugänglichen Orten in der Amateurfunkgemeinschaft ihren eigenen Platz.' }
};
...
function SiteTopbar({ nav, activeTab, locale, user, onLocaleChange, onNavigate, onSignIn, onRegister, onSignOut }: { nav: NavItem[]; activeTab: string; locale: Locale; user: User | null; onLocaleChange: (locale: Locale) => void; onNavigate: (id: string) => void; onSignIn: () => void; onRegister: () => void; onSignOut: () => void }) {
  return <header className="topbar"><div className="brand"><img className="header-banner" src="/mpota-logo-banner.svg" alt="MPOTA — Municipal Parks On The Air" /></div><nav>{nav.map((item) => <button className={(activeTab === item.id || (activeTab === 'park-editor' && item.id === 'park-admin')) ? 'nav-active' : ''} key={item.id} onClick={() => onNavigate(item.id)}>{item.label}</button>)}</nav><div className="header-actions"><select aria-label="Language" value={locale} onChange={(event) => onLocaleChange(event.target.value as Locale)}><option value="en">EN</option><option value="es">ES</option><option value="fr">FR</option><option value="de">DE</option></select>{user ? <><button className="user-pill" onClick={() => onNavigate('profile')}>{user.callsign || user.displayName}</button><button className="button ghost" onClick={onSignOut}>{copy[locale].signOut}</button></> : <><button className="button ghost" onClick={onSignIn}>{copy[locale].signIn}</button><button className="button" onClick={onRegister}>{copy[locale].register}</button></>}</div></header>;
}
...
function ParkEditorPage({ parkId, token, onClose, onSaved }: { parkId: string; token: string; onClose: () => void; onSaved: () => void }) {
...
function ParkDetailPage({ reference, token, onBack, onMessage, nav, activeTab, locale, user, onLocaleChange, onNavigate, onSignIn, onRegister, onSignOut }: { reference: string; token: string; onBack: () => void; onMessage: (message: string) => void; nav: NavItem[]; activeTab: string; locale: Locale; user: User | null; onLocaleChange: (locale: Locale) => void; onNavigate: (id: string) => void; onSignIn: () => void; onRegister: () => void; onSignOut: () => void }) {
  ...
  const detailTopbar = <><SiteTopbar nav={nav} activeTab={activeTab} locale={locale} user={user} onLocaleChange={onLocaleChange} onNavigate={onNavigate} onSignIn={onSignIn} onRegister={onRegister} onSignOut={onSignOut} /><div className="detail-actionbar"><button className="button ghost" onClick={onBack}>← Back to map</button></div></>;
...
function QsoAdminPage({ token, onMessage }: { token: string; onMessage: (message: string) => void }) {
...
function ProfilePage({ token, user, locale, onUserChange, onMessage }: { token: string; user: User; locale: Locale; onUserChange: (user: User) => void; onMessage: (message: string) => void }) {
...
function PolicyPage({ kind, locale, onBack }: { kind: PolicyKind; locale: Locale; onBack: () => void }) {
  const page = policyCopy[locale][kind];
...
function HomePage({ parks, t, locale, token, onMap, onPropose, onQso, onSignIn, onPolicy }: { parks: Park[]; t: Record<string, string>; locale: Locale; token: string; onMap: () => void; onPropose: () => void; onQso: () => void; onSignIn: () => void; onPolicy: (kind: PolicyKind) => void }) {
  const eligibility = homeEligibility[locale];
  const conduct = policyCopy[locale].conduct;
  const rules = policyCopy[locale].rules;
...
export default function App() {
  ...
  const qsoAdminLabel = { en: 'QSO administration', es: 'Administración de QSOs', fr: 'Administration des QSOs', de: 'QSO-Verwaltung' }[locale];
  ...
  const nav = useMemo(() => [{ id: 'home', label: t.home }, { id: 'map', label: t.map }, ...(user ? [{ id: 'propose', label: t.propose }, { id: 'qso', label: t.qso }, { id: 'uploads', label: t.uploads }] : []), { id: 'awards', label: t.awards }, ...(canModerate ? [{ id: 'admin', label: t.admin }, { id: 'park-admin', label: t.parkAdmin }] : []), ...(canGlobalAdmin ? [{ id: 'qso-admin', label: qsoAdminLabel }] : []), ...(canManageUsers ? [{ id: 'users', label: t.users }] : [])], [t, user, canModerate, canGlobalAdmin, canManageUsers, qsoAdminLabel]);
  ...
  if (parkReference) return <ParkDetailPage reference={parkReference} token={token} onBack={closePark} onMessage={setMessage} nav={nav} activeTab={tab} locale={locale} user={user} onLocaleChange={setLocale} onNavigate={(id) => { closePark(); selectTab(id); }} onSignIn={() => setAuthMode('login')} onRegister={() => setAuthMode('register')} onSignOut={() => { setToken(''); setUser(null); localStorage.removeItem('mpota-token'); }} />;

  return <div className="app-shell">
    <SiteTopbar nav={nav} activeTab={tab} locale={locale} user={user} onLocaleChange={setLocale} onNavigate={selectTab} onSignIn={() => setAuthMode('login')} onRegister={() => setAuthMode('register')} onSignOut={() => { setToken(''); setUser(null); localStorage.removeItem('mpota-token'); setTab('home'); }} />
    <main>{tab === 'park-editor' ? null : tab === 'home' ? <HomePage parks={parks} t={t} locale={locale} token={token} onMap={() => setTab('map')} onPropose={() => setTab('propose')} onQso={() => setTab('qso')} onSignIn={() => setAuthMode('login')} onPolicy={(kind) => setTab(kind)} /> : tab === 'conduct' ? <PolicyPage kind="conduct" locale={locale} onBack={() => setTab('home')} /> : tab === 'rules' ? <PolicyPage kind="rules" locale={locale} onBack={() => setTab('home')} /> : <><section className="hero"><div className="hero-copy"><p className="eyebrow">Municipal Parks on the Air</p><h1>{t.hero}</h1><p className="hero-text">{t.heroText}</p><div className="hero-actions"><button className="button" onClick={() => setTab('propose')}>{t.propose}</button><span className="stat"><strong>{parks.length}</strong> {t.approved}</span></div></div></section></>}
      ...
      {tab === 'profile' && user && <ProfilePage token={token} user={user} locale={locale} onUserChange={(updated) => { setUser(updated); setLocale(updated.locale); }} onMessage={setMessage} />}
      ...
      {tab === 'park-admin' && canModerate && <ParkAdminPanel token={token} onEdit={openParkEditor} onMessage={setMessage} />}
      {tab === 'park-editor' && editingParkId && canModerate && <ParkEditorPage parkId={editingParkId} token={token} onClose={closeParkEditor} onSaved={() => { setMessage('Park changes saved.'); closeParkEditor(); }} />}
      {tab === 'qso-admin' && canGlobalAdmin && <QsoAdminPage token={token} onMessage={setMessage} />}
